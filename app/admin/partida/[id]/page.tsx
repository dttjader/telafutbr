...
const MOTIVOS_CARTAO: Record<string, string[]> = {
  amarelo: ['Falta tática','Reclamação com o árbitro','Retardar o jogo','Falta violenta','Simulação','Comemoração excessiva','Desrespeito à distância em cobrança','Agressão Física','Agressão verbal','Mão na bola'],
