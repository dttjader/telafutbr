...
const MOTIVOS_CARTAO: Record<string, string[]> = {
  amarelo: ['Falta tática','Reclamação com o árbitro','Retardar o jogo','Falta violenta','Simulação','Comemoração excessiva','Tirar a camisa','Desrespeito ao jogo','Agressão física','Agressão verbal','Mão na bola'],
